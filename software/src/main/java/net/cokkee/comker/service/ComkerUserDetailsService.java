...
public class ComkerUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username, String spotCode)
            throws UsernameNotFoundException, DataAccessException {
    ...
    public void reloadUserDetails(String spotCode) {
        UserDetails oldUserDetails = getPrincipal();
        if (oldUserDetails == null) return;

        UserDetails userDetails = loadUserByUsername(oldUserDetails.getUsername(), spotCode);
