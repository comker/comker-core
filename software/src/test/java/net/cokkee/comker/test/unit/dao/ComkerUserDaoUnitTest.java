...
@ContextConfiguration(
        classes = {
            ComkerUserDaoUnitTest.GeneralConfig.class,
            ComkerUserDaoUnitTest.ContextConfig.class
        }
)
@Transactional
public class ComkerUserDaoUnitTest extends ComkerAbstractDaoUnitTest {
